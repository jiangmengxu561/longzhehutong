            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'admin_group_id', title: __('Admin_group_id')},
                        {field: 'city', title: __('City'), operate: 'LIKE', table: table, class: 'autocontent', formatter: Table.api.formatter.content},
                        {field: 'order_id', title: __('Order_id')},
                        {field: 'base_amount', title: __('Base_amount'), operate: 'LIKE', table: table, class: 'autocontent', formatter: Table.api.formatter.content},
                        {field: 'commission_rate', title: __('Commission_rate'), operate: 'LIKE', table: table, class: 'autocontent', formatter: Table.api.formatter.content},
