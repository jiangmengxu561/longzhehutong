<template>
	<view class="personal">
		...
		<view class="label" style="margin:92rpx 36rpx 60rpx;">
			<view>车牌</view>
			<input v-model="carnumber" placeholder="请输入车牌号" placeholder-style="color:#CCCCCC" style="text-align: right;" />
		</view>
		<view class="label" style="margin:0 36rpx 60rpx;">
			<view>城市</view>
			<input v-model="city" placeholder="请输入城市" placeholder-style="color:#CCCCCC" style="text-align: right;" />
		</view>
