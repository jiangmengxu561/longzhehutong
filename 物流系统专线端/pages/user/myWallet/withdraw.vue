		...
		<view style="position: relative;z-index: 2;margin-top:-272rpx;">
			...
			<view class="rule-box">
				...
				<view class="rule-item">
					<text class="rule-label">可提现额度</text>
					<text class="rule-value">{{money}} 元</text>
				</view>
				<view class="rule-item">
					<text class="rule-label">每日提现次数</text>
					<text class="rule-value">不限次数</text>
				</view>
				<view class="rule-item">
					<text class="rule-label">提现时间</text>
					<text class="rule-value">不限时间</text>
				</view>
				<view class="rule-item">
					<text class="rule-label">到账时间</text>
					<text class="rule-value highlight">1个工作日</text>
				</view>
				<view class="rule-tip">温馨提示：提现金额将扣除平台服务费5%，请仔细核对收款账户信息。</view>
			</view>
