...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"龙喆互通","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
var _compositionApi = __webpack_require__(/*! @vue/composition-api */ 42);
...
function addUnit(value) {
  if (!(0, _isDef.isDef)(value)) {
    return null;
  }
  value = String(value); // 将值转换为字符串
  // 如果值是数字，则在后面添加单位 "px"，否则保持原始值
  return (0, _isNumeric.isNumeric)(value) ? "".concat(value, "px") : value;
}
...
function unitConvert(value) {
  ...
  // 如果是字符串数字
  if ((0, _isNumeric.isNumeric)(value)) {
    return Number(value);
  }
  // 如果有单位
  if ((0, _isString.isString)(value)) {
...
/***/ 37:
/*!*********************************************************************!*\
  !*** D:/phpstudy_pro/WWW/longzhehutongdaima/物流系统小程序/https/https.js ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    uni.request({
      ...
      success: function success(res) {
        ...
        var route = lastPage && lastPage.route ? lastPage.route : '';
        var isIndexPage = route === 'pages/index/index';
...
function upShop(url, file, options) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    var shouldShowLoading = opts.showLoading !== false;
    var hideUploadLoading = function hideUploadLoading() {
    ...
    var uploadOptions = {
      ...
      success: function success(uploadFileRes) {
        ...
        var data;
        try {
          data = typeof uploadFileRes.data === 'string' ? JSON.parse(uploadFileRes.data) : uploadFileRes.data;
        } catch (e) {
          reject(new Error('服务器响应解析失败'));
          return;
        }
        if (data.code === 0 || data.code === '0') {
          var msg = data.msg || '上传失败';
          uni.showToast({
            title: msg,
            icon: 'none'
          });
...
function uploadImg() {
  return new Promise(function (resolve, reject) {
    uni.chooseImage({
      ...
      fail: function () {
        var _fail = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2(err) {
...
/***/ 41:
/*!*********************************************************************!*\
  !*** D:/phpstudy_pro/WWW/longzhehutongdaima/物流系统小程序/https/utils.js ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var utils = {
  ...
  // 开票税点：type=1 专票、type=2 普票
  taxArray: function taxArray(type) {
    return Number(type) === 2 ? ['1%', '2%'] : ['6%', '9%'];
  },
...
if (false) {} else {
  module.exports = __webpack_require__(/*! ./dist/vue-composition-api.common.js */ 43)
}
...
/***/ 44:
/*!*******************************************************************************!*\
  !*** D:/phpstudy_pro/WWW/longzhehutongdaima/物流系统小程序/uni.promisify.adaptor.js ***!
  \*******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 59:
/*!*********************************************************************!*\
  !*** D:/phpstudy_pro/WWW/longzhehutongdaima/物流系统小程序/https/mixin.js ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
